...
val artworks = listOf(
    ...
    Artwork("213", "Drei Streifen / Zwei Kühe", "Τρία μέρη / Δύο αγελάδες", "Georg Baselitz", "https://goulandris.gr/el/artwork/baselitz-georg-three-stripes-two-cows"),
    ...
    Artwork("257", "Portrait I", "Προσωπογραφία I", "Alberto Giacometti", "https://goulandris.gr/el/artwork/giacometti-alberto-portrait-1"),
    ...
    Artwork("500", "Beiordnung von 99 Köpfen", "Ενενήντα εννέα κεφάλια", "Friedensreich Hundertwasser", "https://goulandris.gr/el/artwork/hundertwasser-ninety-nine-heads"),
    ...
    Artwork("505", "Selon ses faces no. 6", "Σύμφωνα με τα πρόσωπα του αρ. 6.", "François Rouan", "https://goulandris.gr/el/artwork/rouan-francois-according-to-faces"),
    )